        ...
        render: function (options) {
            ...
            layui.jquery.ajax({
                ...
                beforeSend: function(request) {
                    request.setRequestHeader("authorization", layui.sessionData('LocalData')["access_token"]);
                    request.setRequestHeader("refresh_token", layui.sessionData('LocalData')["refresh_token"]);
                },
                success: function (res) {
                    if (res.data == null) {
                        ...
                        miniAdmin.renderLogo(res.data.logoInfo);
                        //miniAdmin.renderClear(options.clearUrl);
                        miniAdmin.renderHome(res.data.homeInfo);
                        miniAdmin.renderAnim(options.pageAnim);
                        miniAdmin.renderUser(res.data.userInfo)
                        miniAdmin.listen();
                        miniMenu.render({
                            menuList: res.data.menuInfo,
